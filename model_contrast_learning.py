...
class DialogueGCNModel(nn.Module):
    def __init__(self, base_model, D_m, D_g, D_p, D_e, D_h, D_a, graph_hidden_size, n_speakers, max_seq_len, window_past, window_future,
                 ...
                 nodal_attention=True, avec=False, no_cuda=False, use_contrastive=False):
    ...
    def forward(self, U, qmask, umask, seq_lengths, labels=None):
        ...
        if self.use_contrastive:
            log_prob, contrast_loss = self.graph_net(
            ...
            return log_prob, edge_index, edge_norm, edge_type, edge_index_lengths, None
...
# Perspective 3 : Intégration d'Apprentissage Contrastif dans DialogueGCN 
