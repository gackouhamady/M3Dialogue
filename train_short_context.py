...
from model_handle_short_context import DialogRNNModel, GRUModel, LSTMModel, MaskedNLLLoss, DialogueGCNModel
...
def train_or_eval_model(model, loss_function, dataloader, epoch, optimizer=None, train=False):
    ...
    for data in dataloader:
        ...
        # Appel du modèle
        log_prob, alpha, alpha_f, alpha_b, _ = model(textf, qmask, umask, lengths)  # Ajout de lengths comme argument
